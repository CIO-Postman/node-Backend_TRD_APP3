...
WHERE CHANGWAT_CODE='+ @CHANGWAT_CODE +'
FROM '+ @tablename + '
WHERE CHANGWAT_CODE='+ @CHANGWAT_CODE +' TMAS 
LEFT OUTER JOIN (
SELECT * , 
CASE 
...
FROM (
	...
	FROM '+ @tablename + ' WHERE CHANGWAT_CODE='+ @CHANGWAT_CODE +' T1
    ...
    VAL_PER_WAH = TJOIN.VAL_PER_WAH
    WHERE CHANGWAT_CODE='+ @CHANGWAT_CODE +'
    FROM '+ @tablename + ' WHERE CHANGWAT_CODE='+ @CHANGWAT_CODE +' TMAS 
    LEFT OUTER JOIN (
    ...
    (
        ...
        SELECT * FROM '+ @tablename + ' WHERE CHANGWAT_CODE='+ @CHANGWAT_CODE +' 
